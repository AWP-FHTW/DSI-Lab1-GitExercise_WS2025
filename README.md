...
```
* Your Name, Student ID, [username](http://github.com/username)
```

### Example

* Alice Example, 123456, [aliceexample](http://github.com/aliceexample)
* John Doe, 234567, [johndoe](http://github.com/johndoe)
* Zara Student, 345678, [zarastudent](http://github.com/zarastudent)
